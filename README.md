...
| 成品 | 说明 |
|------|------|
| [Hot100方法卡_gpt-image-2.pptx](algorithm/ppt_output/Hot100方法卡_gpt-image-2.pptx) | 18 张方法卡，GPT-Image-2 信息图 |
| [Hot100分类总览.pptx](algorithm/ppt_output/Hot100分类总览.pptx) | 题型分类总览，建立全局认知 |

**代码随想录路线（36 讲）**

| 成品 | 说明 |
|------|------|
| ⭐ [代码随想录算法分类图解_顺序版.pptx](algorithm/ppt_output/代码随想录算法分类图解_顺序版.pptx) | 按学习路线顺序排列 —— **系统刷题首选** |
| [代码随想录算法卡_gpt-image-2.pptx](algorithm/ppt_output/代码随想录算法卡_gpt-image-2.pptx) | 36 张方法卡，GPT-Image-2 信息图 |
...
| `fix_algorithm_card_qa.py` | 卡片内容 QA 修复辅助 |

> Hot100 信息图的渲染脚本在 `algorithm/hot100_method_cards/render_method_cards.py`。
